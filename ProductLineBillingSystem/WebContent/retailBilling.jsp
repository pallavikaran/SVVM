...
function mycal(){
	...
	frm.total.value=eval((0.11*subt)+subt);
}
...
<body>
<h1>Welcome to Product Line for Billing System -Retail</h1>
<form action="Controller" method="post">
<input type="button" value="Back" onclick="back()" >
<input type="button" value="Print" onclick="printcmd()" ><br>
<img src="2.png" alt="walmart"><br>

680 <br>
Old Greenville Hwy,<br>
Clemson, <br>
SC 29631<br>
<br>
...
<img src="images.jpg" alt="walmart"><br>
</body>
</html>