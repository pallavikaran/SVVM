...
function mycal(){
	...
	frm.servicetax.value="1.38%";
	frm.esttax.value="20.5%";
	...
	frm.total.value=eval(eval(0.0138*subt)+eval(0.01*subt)+subt);
	alert(frm.total.value);
	frm.servicetaxval.value=eval(0.0138*subt);
...
<body>
<h1>Welcome to Product Line for Billing System -Property Billing</h1>
<form action="Controller" method="post">
<input type="button" value="Back" onclick="back()" >
<input type="button" value="Print" onclick="printcmd()" ><br>
<img src=33.jpg alt="tp"><br>
...
<tr>
	...
	<td>
		<input type="text" name="esttaxval">
	</td>
</tr>
